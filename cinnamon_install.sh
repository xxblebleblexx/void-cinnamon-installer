...
sudo xbps-install -S firefox gnome-terminal gedit telegram-desktop engrampa zstd unzip wget rsv cronie blueman bluez bluez-alsa libspa-bluetooth flatpak
sleep 1
